...
| 11 | ◐ | P1 | Переиспользовать recon между этапами с проверкой свежести | 4 | 4 | M | `refine → build`: `prorab 0.10.0`; технический контур не сделан |
...
**Не сделано:** тот же handoff для `audit → refactor` и `lint-audit → lint-fix`.
