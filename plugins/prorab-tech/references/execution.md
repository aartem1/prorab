...
For commands that run analyzers or the project's own checks: two of the three context-occupancy
limits (the third, `Delegated context returns`, is in `project-knowledge.md`) plus the deterministic
steps.
