...
**Адаптивный бюджет.** Все четыре команды перед разворотом агентов проходят **Фазу 0.5 —
Триаж бюджета** (тир S/M/L): число сканеров/раннеров/скептиков и модель масштабируются под охват
